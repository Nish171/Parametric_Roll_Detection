...
val_in, val_true, val_pred, val_inf_t = get_inference(Data_inf.Val, model, OUT_dim, val_dir)
...
test_in, test_true, test_pred, test_inf_time = get_inference(Data_inf.Test, model, OUT_dim, test_dir)
